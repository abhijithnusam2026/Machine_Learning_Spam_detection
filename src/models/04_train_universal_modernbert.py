...
PIPELINE_STAGE = "04_universal_modernbert"
...
def main():
    ...
    if args.finetune_method == "lora":
        print("Applying LoRA adapters for parameter-efficient ModernBERT training...")
    ...
    mlflow.set_experiment("scam-detection/refactored_pipeline/04_universal_modernbert")
    with mlflow.start_run(run_name=f"04-modernbert-{args.finetune_method}"):
